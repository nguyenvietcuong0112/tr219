...
import com.moneytracker.aimoney.moneymanager.finance.adapter.GuideAdapter;
import com.moneytracker.aimoney.moneymanager.finance.base.BaseActivity;
import com.moneytracker.aimoney.moneymanager.finance.databinding.ActivityGuideBinding;
...
//    }
    ...
    public void goToHome() {
        ...
        if (selectedCurrencyCode.isEmpty()) {
            startActivity(new Intent(GuideActivity.this, CurrencyUnitActivity.class));
        } else {
